...
all.data.combined$brand_33200_avg_rate <- NULL
all.data.combined$brand_33200_display <- NULL
all.data.combined$brand_33200_pricereduction <- NULL

all.data.combined$PRICE_PER_OUNCE <- NULL

write.csv(all.data.combined, file="data/finaldata.csv")
```

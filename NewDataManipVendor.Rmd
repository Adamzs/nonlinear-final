...
# 
# priceDfDisplay[which(priceDfDisplay$VEND == 24291),]
priceDfDisplay$DISPLAY <- as.logical(priceDfDisplay$DISPLAY)
...
noChoicePriceDfDisplay <- noChoicePriceDfDisplay %>%
  group_by(WEEK) %>%
  dplyr::summarise(DISPLAY = any(DISPLAY))
...
mnlmodel <- gam(list(choice~Combined.Pre.Tax.Income.of.HH + MALE_SMOKE + FEM_SMOKE + WEEK + LOYALTY.10158 + AVGRATE.10158 +  DISPLAY.10158 +  PRICEREDUCTION.10158,  ~Combined.Pre.Tax.Income.of.HH + MALE_SMOKE + FEM_SMOKE + WEEK +  LOYALTY.33200 + AVGRATE.33200 + DISPLAY.33200 + PRICEREDUCTION.33200, ~Combined.Pre.Tax.Income.of.HH + MALE_SMOKE + FEM_SMOKE + WEEK + LOYALTY.35000 + AVGRATE.35000 + DISPLAY.35000 + PRICEREDUCTION.35000, ~Combined.Pre.Tax.Income.of.HH + MALE_SMOKE + FEM_SMOKE + WEEK + LOYALTY.37000 + AVGRATE.37000 + DISPLAY.37000 + PRICEREDUCTION.37000, ~Combined.Pre.Tax.Income.of.HH + MALE_SMOKE + FEM_SMOKE + WEEK + LOYALTY.53100 + AVGRATE.53100 + DISPLAY.53100 + PRICEREDUCTION.53100, ~Combined.Pre.Tax.Income.of.HH + MALE_SMOKE + FEM_SMOKE +  WEEK + LOYALTY.77326 + AVGRATE.77326 + DISPLAY.77326 + PRICEREDUCTION.77326), data=finaldata, family=multinom(K=6))

gamWeekModel <- gam(list(choice~Combined.Pre.Tax.Income.of.HH + MALE_SMOKE + FEM_SMOKE + s(WEEK) + LOYALTY.10158 + AVGRATE.10158 +  DISPLAY.10158 +  PRICEREDUCTION.10158,  ~Combined.Pre.Tax.Income.of.HH + MALE_SMOKE + FEM_SMOKE + s(WEEK) +  LOYALTY.33200 + AVGRATE.33200 + DISPLAY.33200 + PRICEREDUCTION.33200, ~Combined.Pre.Tax.Income.of.HH + MALE_SMOKE + FEM_SMOKE + s(WEEK) + LOYALTY.35000 + AVGRATE.35000 + DISPLAY.35000 + PRICEREDUCTION.35000, ~Combined.Pre.Tax.Income.of.HH + MALE_SMOKE + FEM_SMOKE + s(WEEK) + LOYALTY.37000 + AVGRATE.37000 + DISPLAY.37000 + PRICEREDUCTION.37000, ~Combined.Pre.Tax.Income.of.HH + MALE_SMOKE + FEM_SMOKE + s(WEEK) + LOYALTY.53100 + AVGRATE.53100 + DISPLAY.53100 + PRICEREDUCTION.53100, ~Combined.Pre.Tax.Income.of.HH + MALE_SMOKE + FEM_SMOKE +  s(WEEK) + LOYALTY.77326 + AVGRATE.77326 + DISPLAY.77326 + PRICEREDUCTION.77326), data=finaldata, family=multinom(K=6))
